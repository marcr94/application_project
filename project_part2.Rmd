...
lines(density(train_imputed_mean$area), col = "red")
lines(density(train_imputed_cart$area), col = "green")

# floors
plot(density(train_without_dummyNA$floors, na.rm = TRUE))
lines(density(train_imputed_mean$floors), col = "red")
lines(density(train_imputed_cart$floors), col = "green")

# rooms
plot(density(train_without_dummyNA$rooms, na.rm = TRUE))
lines(density(train_imputed_mean$rooms), col = "red")
lines(density(train_imputed_cart$rooms), col = "green")

# year_built
plot(density(train_without_dummyNA$year_built, na.rm = TRUE))
lines(density(train_imputed_mean$year_built), col = "red")
lines(density(train_imputed_cart$year_built), col = "green")
